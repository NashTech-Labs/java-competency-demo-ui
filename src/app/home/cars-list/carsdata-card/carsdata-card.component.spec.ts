...
describe('CarsdataCardComponent', () => {
    ...
    it('should update car data when input properties change', () => {
        ...
        expect(ComponentElement.textContent).toContain('25 mpg');
        ...
        expect(ComponentElement.textContent).toContain('28 mpg');
