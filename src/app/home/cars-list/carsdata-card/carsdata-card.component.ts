/**
 * CarsdataCardComponent is a reusable component that displays information about a car in a card format.
 * It receives car data as input properties from the parent component and displays it in the template.
 */
